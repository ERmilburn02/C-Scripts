// This method only works on Windows due to using Win32 dlls
    ...
    public static string getUserDisplayName()
    {
        ...
        if (0 != GetUserNameEx(2, username, ref userNameSize))
        {
            ...
            try
            {
                ...
                if (0 == NetUserGetInfo(dc.IPAddress, Regex.Replace(username.ToString(), @".+\\(.+)", "$1"), 10, out bufPtr))
                {
